...
function Login({ formData, handleForm, submitForm }) {
    return (
                ...
                <div className="login-wrapper">
                    <div className="login-container signup-container">
                        ...
                        <form name="signup" className="sign-up">
                            ...
                            <div className="form-control">
                                <input type="password" name="password" id='password' value={formData.password} onChange={handleForm} className="form-input" placeholder="none" />
